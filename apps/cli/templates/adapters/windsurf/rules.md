...
> Placement: `.windsurf/rules.md` (Windsurf reads this automatically for project rules).
...
4. **Confirm before destructive operations** — `rm`, `DROP TABLE`, force push, migrations.
...
1. Write session digest to `{{VAULT_DIR}}/01-SESSIONS/YYYY-MM-DD/session-HHMM-windsurf.md`
...
5. Memory commit (vault files only): `memory: YYYY-MM-DD windsurf — <summary>`
